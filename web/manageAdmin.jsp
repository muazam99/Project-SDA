        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card" >
                 <img src="image/add_user.png" class="card-img-top" alt="addUser" width="200" height="400">
                  <a href="AdminController?command=Add-Admin-Page" class="btn btn-primary btn-lg">Add Admin</a>
              </div>
            </div> 
            ...
            <div class="col-md-3">
                <div class="card">
                  ...
                  <a href="AdminController?command=Delete-Admin-Page" class="btn btn-danger btn-lg">Delete Admin</a>
              </div>
            </div> 
